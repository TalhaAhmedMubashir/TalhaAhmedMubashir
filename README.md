...
- 📧 **SMTP/Gmail** automation & **Android app certificate** handling via Play Store & **IOS app certificate** via App Store
- 🔐 **OneSignal event stream** configuration for multi-app handling
...
- Automate complex workflows: SMTP, Google certificates, push notifications
...
- 🧪 Open to QA, Automation & Testing collaborations
